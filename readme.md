...
- Laf Oferta Agendada (Nome do plugin)
- laf-oferta-agendada (nome dos arquivos, nome do text domain e slug da url do repositório)
- LAF_OA_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- laf_oa_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Laf Oferta Agendada, através do próprio sistema de atualizações do WordPress
